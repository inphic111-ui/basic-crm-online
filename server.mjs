...
async function initializeDatabase() {
  ...
  try {
    ...
    if (!audioTableCheckResult.rows[0].exists) {
      ...
      // 插入 10 筆測試資料
      const testData = [
        { customer_id: 1, business_name: '何雨達', product_name: '智能軟件', call_date: '2025-11-12', call_time: '12:45:00', audio_filename: '20251112_何雨達_智能軟件_1001_1145.wav', audio_url: 'https://example.com/audio1.mp3', transcription_text: '客戶詢問了智能軟件的功能、定價和實施時間表。', transcription_status: 'completed', analysis_summary: '客戶對智能軟件感興趣，需要進一步報價和技術演示', analysis_status: 'completed', ai_tags: ['感興趣', '需要演示', '預算充足'], overall_status: 'pending' },
        { customer_id: 2, business_name: '郭庭碩', product_name: '投資顧問', call_date: '2025-11-12', call_time: '10:11:00', audio_filename: '20251112_郭庭碩_投資顧問_1011_1053.wav', audio_url: 'https://example.com/audio2.mp3', transcription_text: '討論了投資組合管理、風險評估和市場分析工具。', transcription_status: 'completed', analysis_summary: '客戶要求進一步的投資計劃和成本分析', analysis_status: 'completed', ai_tags: ['投資管理', '風險評估', '數據分析'], overall_status: 'pending' },
        { customer_id: 3, business_name: '鍾汶憲', product_name: '庫存管理系統', call_date: '2025-11-11', call_time: '05:59:00', audio_filename: '20251111_鍾汶憲_庫存管理系統_0559_0541.wav', audio_url: 'https://example.com/audio3.mp3', transcription_text: '詢問了系統集成能力、成本和實施時間表。', transcription_status: 'completed', analysis_summary: '客戶對系統功能滿意，需要演示和集成測試', analysis_status: 'completed', ai_tags: ['庫存管理', '系統集成', '成本有效'], overall_status: 'pending' },
        { customer_id: 4, business_name: '何佳珊', product_name: 'ERP 系統', call_date: '2025-11-10', call_time: '09:14:00', audio_filename: '20251110_何佳珊_ERP系統_0914_0227.wav', audio_url: 'https://example.com/audio4.mp3', transcription_text: '討論了生產流程優化、報告功能和數據可視化。', transcription_status: 'completed', analysis_summary: '客戶需要定制化解決方案，預期下週做決定', analysis_status: 'completed', ai_tags: ['ERP', '生產管理', '定制化'], overall_status: 'pending' },
        { customer_id: 5, business_name: '何雨達', product_name: '案例管理系統', call_date: '2025-11-09', call_time: '02:30:00', audio_filename: '20251109_何雨達_案例管理系統_0230_0610.wav', audio_url: 'https://example.com/audio5.mp3', transcription_text: '討論了文檔管理、時間追蹤和計費功能。', transcription_status: 'completed', analysis_summary: '客戶對系統功能滿意，預期本月做決定', analysis_status: 'completed', ai_tags: ['案例管理', '文檔管理', '時間追蹤'], overall_status: 'pending' },
        { customer_id: 6, business_name: '郭庭碩', product_name: '訂房管理系統', call_date: '2025-11-08', call_time: '02:30:00', audio_filename: '20251108_郭庭碩_訂房管理系統_0230_0440.wav', audio_url: 'https://example.com/audio6.mp3', transcription_text: '詢問了多語言支持、支付集成和客戶關係管理功能。', transcription_status: 'completed', analysis_summary: '客戶計劃下月簽約，需要最終報價', analysis_status: 'completed', ai_tags: ['訂房管理', '支付集成', '收入管理'], overall_status: 'pending' },
        { customer_id: 7, business_name: '鍾汶憲', product_name: '物流管理系統', call_date: '2025-11-07', call_time: '02:30:00', audio_filename: '20251107_鍾汶憲_物流管理系統_0230_0730.wav', audio_url: 'https://example.com/audio7.mp3', transcription_text: '討論了路線優化、實時追蹤和燃料成本管理。', transcription_status: 'completed', analysis_summary: '客戶對成本節省效果感興趣', analysis_status: 'completed', ai_tags: ['物流管理', '路線優化', '成本節省'], overall_status: 'pending' },
        { customer_id: 8, business_name: '何佳珊', product_name: '房產管理系統', call_date: '2025-11-06', call_time: '02:30:00', audio_filename: '20251106_何佳珊_房產管理系統_0230_0520.wav', audio_url: 'https://example.com/audio8.mp3', transcription_text: '討論了租戶服務、維護追蹤和自動計費功能。', transcription_status: 'completed', analysis_summary: '客戶需要進一步的技術支持和定制化方案', analysis_status: 'completed', ai_tags: ['房產管理', '租戶服務', '自動計費'], overall_status: 'pending' }
      ];
