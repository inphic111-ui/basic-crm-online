...
var users, recordings, transcriptions, aiAnalyses, analysisHistory;
var init_schema = __esm({
  "drizzle/schema.ts"() {
    ...
    recordings = mysqlTable("recordings", {
      id: int("id").autoincrement().primaryKey(),
    ...
    transcriptions = mysqlTable("transcriptions", {
      id: int("id").autoincrement().primaryKey(),
    ...
    analysisHistory = mysqlTable("analysisHistory", {
      id: int("id").autoincrement().primaryKey(),
      recordingId: int("recordingId").notNull(),
